...
class Guest_Checkout
{
    ...
    public function simplify_fields($fields)
    {
        ...
        if (isset($fields['billing']['billing_email'])) {
            ...
            $fields['billing']['billing_email']['placeholder'] = __('nama@gmail.com', 'woo-express-checkout');
        ...
        if (isset($fields['billing']['billing_first_name'])) {
            ...
            $fields['billing']['billing_first_name']['placeholder'] = __('Budi Santoso', 'woo-express-checkout');
            $fields['billing']['billing_first_name']['priority']    = 20;
            $fields['billing']['billing_first_name']['class']       = array('form-row-wide');
        }

        if (isset($fields['billing']['billing_phone'])) {
            $fields['billing']['billing_phone']['label']       = __('Nomor WhatsApp', 'woo-express-checkout');
            $fields['billing']['billing_phone']['placeholder'] = __('08xxxxxxxxxx', 'woo-express-checkout');
